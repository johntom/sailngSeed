...
//.config(function config( $stateProvider ) {
    ...
    .controller( 'TodoCtrl',['$scope', '$sails', 'lodash', 'config', 'titleService', 'TodoModel','$filter', 'ngTableParams', function TodoController( $scope, $sails, lodash, config, titleService, TodoModel,$filter, ngTableParams ) {
